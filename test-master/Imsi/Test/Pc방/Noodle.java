...
import javax.swing.ImageIcon;//이미지를 넣을수 있게한다.
import javax.swing.JButton;//버튼을 사용할수 있도록 한다.
import javax.swing.JPanel;// 패널을 생성 할수 있도록 사용

public class Noodle extends JPanel{// 클래스Noodle에 JPanel을 상속한다

	public Noodle(JButton a, JButton b, JButton c, JButton d){//버튼에 변수를 지정 해준다.
